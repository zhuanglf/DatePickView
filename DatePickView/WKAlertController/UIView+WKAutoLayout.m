...
@implementation UIView (WKAutoLayout)
...
- (NSLayoutConstraint *)addConstraintCenterXToView:(UIView *)yView constant:(CGFloat)constant
{
    if (yView) {
        NSLayoutConstraint *centerXConstraint = [NSLayoutConstraint constraintWithItem:yView attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterX multiplier:1.0 constant:constant];
